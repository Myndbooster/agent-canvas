...
import { Globe, ListTodo, SquareChevronRight, Flag } from "lucide-react";
...
export function ConversationTabs({
  ...
  const tabs = [
    ...
    {
      tabValue: "checkpoints",
      isActive: isTabActive("checkpoints"),
      icon: Flag,
      onClick: () => selectTab("checkpoints"),
      tooltipContent: t(I18nKey.COMMON$CHECKPOINTS),
      tooltipAriaLabel: t(I18nKey.COMMON$CHECKPOINTS),
      label: t(I18nKey.COMMON$CHECKPOINTS),
    },
  ];
